...
public 	void LimpiarTable() {
	...
	public VistaCliente() {
		...
		JLabel lblNewLabel_3 = new JLabel("Bienvenid@");
		lblNewLabel_3.setBounds(98, 86, 106, 19);
		...
		JLabel lblNewLabel_3_1 = new JLabel("Tu Rutina");
		lblNewLabel_3_1.setBounds(98, 125, 94, 19);
		...
		JLabel lblNewLabel_3_2 = new JLabel("Tu Dieta");
		lblNewLabel_3_2.setBounds(98, 168, 94, 19);
		...
		textNombre.setBounds(202, 86, 139, 20);
		...
		lblNewLabel_4_1.setBounds(345, 116, 32, 32);
		txtClientes.add(lblNewLabel_4_1);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(202, 126, 139, 22);
		txtClientes.add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBounds(202, 169, 139, 22);
		txtClientes.add(comboBox_1);
		
		JLabel lblNewLabel_4_1_2 = new JLabel("");
		lblNewLabel_4_1_2.setIcon(new ImageIcon("C:\\Users\\pc\\eclipse-workspace\\AppGym\\src\\img\\busc.png"));
		lblNewLabel_4_1_2.setForeground(Color.LIGHT_GRAY);
		lblNewLabel_4_1_2.setBackground(new Color(255, 140, 0));
		lblNewLabel_4_1_2.setBounds(345, 159, 32, 32);
		txtClientes.add(lblNewLabel_4_1_2);
